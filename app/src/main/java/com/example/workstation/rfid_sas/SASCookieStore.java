...
import com.example.workstation.rfid_sas.SerializableHttpCookie;

public class SASCookieStore implements CookieStore {
    private static final String TAG = SASCookieStore.class.getSimpleName();
    ...
    public SASCookieStore(Context context)
    {
